...
public class analyseact extends AppCompatActivity {
    ...
    String stz,st2,st3,st4,stn, sta,staname, stb,stbname,sl1,sl2,sl3,sl4,sl5,stnc;
    TextView tvsu,tvl1,tvl2,tvl3,tvl4,tvl5,tvl6,tv1,tv2,tv3,tv4,tvf,tv3a;
    ListView lv2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed (new Runnable ( ) {
            ...
            public void run() {
                ...
                description.setText("Number of Students");
